				...
				if($child->object == 'category'){
			        ...
			        $r = new WP_Query( apply_filters( 'widget_posts_args', 
			          ...
			          if ($r->have_posts()) :
							...
							$output.= "><div class='subcat-thumbnail'><a href='".get_permalink()."' title='".get_the_title()."'>".get_the_post_thumbnail( get_the_ID(), array(40,40))."</a></div><div class='subcat-title'><a href='".get_permalink()."' title='".get_the_title()."'> ".get_the_title()."</a><span></span></div></li>";
					            } 
